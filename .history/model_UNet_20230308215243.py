...
class res_bolock(nn.Module):
    ...
    def __init__(self, channels):
        ...
        self.layer_1 = C_layer(channels, channels, 3, 1, 1)
        self.layer_2 = C_layer(channels, channels, 3, 1, 1)
...
class u_net_heavy(nn.Module):
    def __init__(self, dim_in, dim_out):
        ...
        # sementic
        self.sementic_1 = ResBlock(1+3,num*1, 7, 1, 3)
...
#         num = 32       
#         # encoder
#         self.encoder_1 = C_layer(dim_in,num*1, 7, 1, 3)
#         self.encoder_2 = RDB(num*1, num*1, 3, 1, 1)
#         self.down_1 = CAS(num*1)
#         self.encoder_3 = C_layer(num*1, num*2, 3, 1, 1)
#         self.encoder_4 = RDB(num*2, num*2, 3, 1, 1)
#         self.down_2 = CAS(num*2)
#         self.encoder_5 = C_layer(num*2, num*4, 3, 1, 1)
#         self.encoder_6 = RDB(num*4, num*4, 3, 1, 1)
#         self.down_3 = CAS(num*4)
#         self.encoder_7 = C_layer(num*4, num*8, 3, 1, 1)
#         self.encoder_8 = RDB(num*8, num*8, 3, 1, 1)
#         self.down_4 = CAS(num*8)
#         self.encoder_9 = C_layer(num*8, num*16, 3, 1, 1)
...
#         # sementic
#         self.sementic_1 = C_layer(1+3,num*1, 7, 1, 3)
#         self.sementic_2 = C_layer(num*1, num*1, 3, 1, 1)
#         self.trans_1 = CAS(num*1)
#         self.sementic_3 = C_layer(num*2, num*2, 3, 1, 1)
#         self.sementic_4 = C_layer(num*2, num*2, 3, 1, 1)
#         self.trans_2 = CAS(num*2)
#         self.sementic_5 = C_layer(num*4, num*4, 3, 1, 1)
#         self.sementic_6 = C_layer(num*4, num*4, 3, 1, 1)
#         self.trans_3 = CAS(num*4)
#         self.sementic_7 = C_layer(num*8, num*8, 3, 1, 1)
#         self.sementic_8 = C_layer(num*8, num*8, 3, 1, 1)
#         self.trans_4 = CAS(num*8)
#         self.sementic_9 = C_layer(num*16, num*16, 3, 1, 1)
#         self.sementic_10 = C_layer(num*16, num*16, 3, 1, 1)
#         self.trans_5 = CAS(num*16)

#         # decoder
#         self.up_1 = CAS(num*32, True)
#         self.decoder_1 = RDB(num*32, num*32, 3, 1, 1)
#         self.decoder_2 = C_layer(num*32, num*16, 3, 1, 1)
#         self.up_2 = CAS(num*24, True)
#         self.decoder_3 = RDB(num*24, num*24, 3, 1, 1)
#         self.decoder_4 = C_layer(num*24, num*8, 3, 1, 1)
#         self.up_3 = CAS(num*12, True)
#         self.decoder_5 = RDB(num*12, num*12, 3, 1, 1)
#         self.decoder_6 = C_layer(num*12, num*6, 3, 1, 1)
#         self.up_4 = CAS(num*8, True)
#         self.decoder_7 = RDB(num*8, num*8, 3, 1, 1)
#         self.decoder_8 = C_layer(num*8, num*2, 3, 1, 1)
#         self.up_5 = CAS(num*3, True)
#         self.decoder_9 = C_layer(num*3, num*1, 3, 1, 1)
#         self.decoder_10 = nn.Conv2d(num, dim_out, 3, 1, 1)
