...
class OutLayer(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.outc = nn.Upsample(size=(512,512),mode='bilinear')
    def forward(self, x):
        # return self.conv(x)
