...
class LRBlock(nn.Module):
    def __init__(self, channel1,channel2,kernel_size=3,stride=1,padding=1):
        ...
        self.channel1= channel1 // 2
        self.channel2= channel2 - self.channel1

        self.convblock = nn.Sequential(
            nn.Conv2d(self.channel1, self.channel2, kernel_size, stride, padding),
            nn.LeakyReLU(0.05),
            nn.Conv2d( self.channel1, self.channel2, 3, 1, 1),
            nn.LeakyReLU(0.05),
            nn.Conv2d( self.channel1, self.channel2, 3, 1, 1),
        )
        ...
        self.fuse1 = nn.Conv2d( self.channel1, self.channel2, 1, 1, 0)
        self.fuse2 = nn.Conv2d( self.channel1, self.channel2, 1, 1, 0)
        self.fuse = nn.Conv2d( self.channel1, self.channel2, 1, 1, 0)
...
class u_net_heavy(nn.Module):
    ...
    def encoder(self, x, y):
        ...
        x_1 = self.fea_conv(x)
        x_1 = self.encoder_1(x_1)          #[1,32,512,512]
