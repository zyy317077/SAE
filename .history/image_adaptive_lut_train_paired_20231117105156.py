...
parser.add_argument("--output_dir", type=str, default="Ab/base",help="path to save model")
parser.add_argument("--result_dir", type=str, default="result",help="path to save result")
parser.add_argument("--image_dir", type=str, default='./save_images/Ab/base',help="path to Dataset")
