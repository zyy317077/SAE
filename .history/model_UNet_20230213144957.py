...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.out = nn.Conv2d(256,3,8,padding=0)
    ...
    def forward(self, x):
        ...
        # x1 = self.cbam1(x1) + x1
        x1 = self.inc1(x1)            [1,16,128,128]
        # x1 = self.inc2(x0)
        x2 = self.down1(x1)           [1,32,64,64]
        # x2 = self.cbam2(x2) + x2
        x3 = self.down2(x2)           [1,64,32,32]
        # x3 = self.cbam3(x3) + x3
        x4 = self.down3(x3)           [1,128,16,16]
        # x4 = self.cbam4(x4) + x4
        x5 = self.down4(x4)           [1,256,8,8]
        x5 = self.out(x5)             [1,3,1,1]
